...
(function () {
  ...
  const MENU = [
    ...
    { sep: 'القرآن والعبادة', id: 'sec-quran' },
    ...
    { href: 'tasmee.html',       icon: '🎙️', label: 'تسميع القرآن',    section: 'sec-quran' },
    { href: 'takbeer.html',      icon: '📿', label: 'المسبحة',          section: 'sec-quran' },
    { href: 'adhkar.html',       icon: '🤲', label: 'الأذكار',          section: 'sec-quran' },
    { href: 'nawawi.html',       icon: '📜', label: 'الأربعون النووية', section: 'sec-quran' },
    { href: "du'a.html",         icon: '🌿', label: 'الأدعية',          section: 'sec-quran' },
    { href: 'dua-guide.html',    icon: '🙏', label: 'قيم الدعاء',       section: 'sec-quran' },
    { href: 'ruqyah.html',       icon: '🛡️', label: 'الرقية الشرعية',  section: 'sec-quran' },
    { href: 'sunan.html',        icon: '🌙', label: 'السنن المهجورة',  section: 'sec-quran' },
    { href: 'worship.html',      icon: '✅', label: 'جدول العبادات',    section: 'sec-quran' },
